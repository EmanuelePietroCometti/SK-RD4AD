...
from dataset.dataset import MVTecDataset,MVTecDataset_no_seg,visADataset,VADDataset_no_seg
...
def train(epochs, learning_rate, res, batch_size, print_epoch, seg, data_path, save_path, print_canshu, score_num, print_loss, img_path, vis, cut, layerloss, rate, print_max, net, L2, seed): 
    image_size = 256
    ...
    if seg == 0:  
        test_data = VADDataset_no_seg(root=test_path, transform=data_transform, phase="test") 
